        ...
        <>
            ...
            <section className='sectionsoffirstpage sec22'>
                ...
                <div className='textpage2'>
                    <p>Обучаться игре на ударной установке в школе DrumSchool могут все желающие, независимо от начального уровня и возраста. Индивидуальный подход практикуется в работе с каждым учеником.</p>
                    <p>Программа включает практические и теоретические занятия по техническим и музыкальным аспектам исполнения, игровая практика, работа под метрономом и фонограммы.</p>
